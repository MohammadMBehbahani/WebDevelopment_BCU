        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBasket_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    UserOrderCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCartItem_UserBasket_UserBasketId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserOrdersId = table.Column<long>(type: "bigint", nullable: false),
                    ProductId = table.Column<long>(type: "bigint", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    InserDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserOrderDetails_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOrderDetails_UserOrders_UserOrdersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "51cc04c4-e673-478a-9616-f9afbb0fe6f7", "51cc04c4-e673-478a-9616-f9afbb0fe6f7", "normaluser", "normaluser" }
                });
            ...
            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "51cc04c4-e673-478a-9616-f9afbb0fe6f7", "c49c10c7-f5cb-4504-a528-c78a9012a457" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItem_UserBasketId",
                table: "ShoppingCartItem",
                column: "UserBasketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrderDetails_ProductId",
                table: "UserOrderDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_UserOrderDetails_UserOrdersId",
                table: "UserOrderDetails",
                column: "UserOrdersId");
